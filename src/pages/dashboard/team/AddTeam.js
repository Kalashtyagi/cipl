                    ...
                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-6">
                            <div className="md:grid md:grid-cols-1 sm:grid-cols-1 md:gap-1">
                                ...
                                <input required onChange={(e)=>setName(e.target.value)} type="text" className="shadow appearance-none border rounded w-auto py-1 px-1 text-black" />
                            </div>
                            <div className="md:grid md:grid-cols-1 sm:grid-cols-1 md:gap-1">
                                <label htmlFor="company_website" className="block text-sm font-medium text-gray-700">
                                    Email <span className='text-red-400'>*</span>
                                </label>
                                <input required onChange={(e)=>setEmail(e.target.value)} type="email" className="shadow appearance-none border rounded max-w-3xl py-1 px-1 text-black" />
                            </div>
                            <div className="md:grid w-full md:grid-cols-1 sm:grid-cols-1 md:gap-1">
                                ...
                                <input required minLength={6} onChange={(e)=>setPassword(e.target.value)} type={showPassword?"text":"password"} className=" appearance-none border w-full border-r-0 rounded-r-none rounded py-1 px-1 text-black" />
                            ...
                            <div className="md:grid md:grid-cols-1 sm:grid-cols-1 md:gap-1">
                                ...
                                <input required minLength={10} maxLength={10} onChange={(e)=>setPhone(e.target.value)} type="text" className="shadow appearance-none border rounded w-auto py-1 px-1 text-black" />
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-1 sm:grid-cols-1 gap-6">
                            <div className="md:grid md:grid-cols-1 sm:grid-cols-1 md:gap-1">
                                ...
                                <select required className="shadow border rounded w-full py-1 px-1 overflow-scroll h-10 text-black" onChange={(e)=>setRole(e.target.value)}>
